...
// MOD Note: Do not change this part - Merkur
	...
	m_strCurVersionLongDbg.Format(_T("%u.%u%c Build 0%u"), CemuleApp::m_nVersionMjr, CemuleApp::m_nVersionMin, _T('a') + CemuleApp::m_nVersionUpd , CemuleApp::m_nVCVersionBld);
	#ifdef _DEBUG
		m_strCurVersionLong = m_strCurVersionLongDbg;
	#else
		m_strCurVersionLong.Format(_T("%u.%u%c Build 0%u"), CemuleApp::m_nVersionMjr, CemuleApp::m_nVersionMin, _T('a') + CemuleApp::m_nVersionUpd , CemuleApp::m_nVCVersionBld);
	#endif
#else
	m_strCurVersionLongDbg.Format(_T("%u.%u%c VeryCD Build 0%u"), CemuleApp::m_nVersionMjr, CemuleApp::m_nVersionMin, _T('a') + CemuleApp::m_nVersionUpd , CemuleApp::m_nVCVersionBld);
	#ifdef _DEBUG
		m_strCurVersionLong = m_strCurVersionLongDbg;
	#else
		m_strCurVersionLong.Format(_T("%u.%u%c VeryCD Build 0%u"), CemuleApp::m_nVersionMjr, CemuleApp::m_nVersionMin, _T('a') + CemuleApp::m_nVersionUpd , CemuleApp::m_nVCVersionBld);
	#endif
#endif
...
//#endif
	//COMMENTED by fengwen on 2006/11/15	<end> : 始终做异常处理
		theCrashDumper.Enable(_T("eMule ") + m_strCurVersionLongDbg, false);
