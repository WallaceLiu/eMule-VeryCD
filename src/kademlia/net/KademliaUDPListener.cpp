...
void CKademliaUDPListener::FirewalledCheck(uint32 uIP, uint16 uUDPPort)
{
	...
	fileIO.WriteUInt16(thePrefs.GetPort());
//#ifdef _LOWTOLOW_SE
//	uint8 uUdpPortReq = 0x01;
//	fileIO.WriteUInt8(uUdpPortReq);
//#endif
...
//	if (uLenPacket == 3)
//	{
//		uint8 uUdpPortReq = fileIO.ReadUInt8();
//		if (uUdpPortReq == 0x01)
//		{
...
//	if (uLenPacket == 6)
//	{
//		uint16 uFirewalledPort = fileIO.ReadUInt16();
//
//		//Update con state only if something changes.
//		if ( thePrefs.GetUDPPort() != uFirewalledPort )
//		{
//			thePrefs.udpport = uFirewalledPort;
//			theApp.emuledlg->ShowConnectionState();
//		}
//	}
//#endif
